...
from app.forms.company_forms.company_form import validate_phone
...
class RegisterFormAccouting(FlaskForm):
    ...
    dataEntrada = DateField("dataEntrada", validators=[DataRequired(message="Você precisa entrar com uma data válida.")], format='%d/%m/%Y', render_kw={"placeholder": 'dd/mm/yyyy'})
